    ...
    <div class="pt-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap pt-4 gap-4 responsive-margin">
                <div class="bg-white w-60 overflow-hidden shadow-sm sm:rounded-lg m-auto">
                ...
                <div class="bg-white w-60 overflow-hidden shadow-sm sm:rounded-lg m-auto">
                    <div class="p-6 text-gray-900">
                        ...
                        <p class="font-extrabold text-2xl text-right pt-2">{{ App\Models\Submission::where('status', 0)->count() }}</p>
                    </div>
                </div>
                ...
                <div class="bg-white w-60 overflow-hidden shadow-sm sm:rounded-lg m-auto">
                    <div class="p-6 text-gray-900">
                        ...
                        <p class="font-extrabold text-2xl text-right pt-2">{{ App\Models\Submission::where('status', 1)->count() }}</p>
                    </div>
                </div>
            </div>
            @endhasrole
